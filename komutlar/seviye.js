...
exports.run = async (client, msg, args) => {
  msg.delete();
  const yasak = client.emojis.get('799724043879317544');
  if (msg.channel.id !== '801730957190365194') return msg.channel.send(`${yasak} **Bu komutun kullanımı, bu kanalda engellenmiştir.**`).then(m => m.delete(5000));
